                                 ...
                                 <ul class="nofitications-dropdown">
                                     <li class="dropdown head-dpdn">
                                         ...
                                         <ul class="dropdown-menu">
                                             ...
                                             <li><a href="#">
                                                <div class="user_img"><img src="{{url('public/assets/images/in11.jpg')}}" alt=""></div>
                                             ...
                                             <li class="odd"><a href="#">
                                                 <div class="user_img"><img src="{{url('public/assets/images/in10.jpg')}}" alt=""></div>
                                                <div class="notification_desc">
                                                 <p>Lorem ipsum dolor </p>
                                                 <p><span>1 hour ago</span></p>
                                                 </div>
                                             ...
                                             <li><a href="#">
                                                <div class="user_img"><img src="{{url('public/assets/images/in9.jpg')}}" alt=""></div>
                                                <div class="notification_desc">
                                                 <p>Lorem ipsum dolor</p>
                                                 <p><span>1 hour ago</span></p>
                                                 </div>
                                     ...
                                     <li class="dropdown head-dpdn">
                                         ...
                                         <ul class="dropdown-menu">
                                             ...
                                             <li><a href="#">
                                                 <div class="user_img"><img src="{{url('public/assets/images/in8.jpg')}}" alt=""></div>
                                                <div class="notification_desc">
                                                 <p>Lorem ipsum dolor</p>
                                                 <p><span>1 hour ago</span></p>
                                                 </div>
                                              ...
                                              <li class="odd"><a href="#">
                                                 <div class="user_img"><img src="{{url('public/assets/images/in6.jpg')}}" alt=""></div>
                                                <div class="notification_desc">
                                                 <p>Lorem ipsum dolor</p>
                                                 <p><span>1 hour ago</span></p>
                                                 </div>
                                              ...
                                              <li><a href="#">
                                                 <div class="user_img"><img src="{{url('public/assets/images/in7.jpg')}}" alt=""></div>
                                                <div class="notification_desc">
                                                 <p>Lorem ipsum dolor</p>
                                                 <p><span>1 hour ago</span></p>
                                                 </div>
                                     ...
                                     <li class="dropdown profile_details_drop">
                                         <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                             <div class="profile_img">
                                                 <span class="prfil-img"><img src="{{url('public/assets/images/saravananPRO.jpeg')}}" alt=""> </span>
                                                 <div class="user-name">
                                                    
					 @if ($sess_email = Session::get('em'))
					 <p>
					 {{ $sess_email }}
					 </p>
					 @endif
                                 ...
                                 <div class="card-body p-b-20">
                                     <div class="list-group">
                                         <a class="list-group-item media" href="">
                                              <div class="pull-left">
                                                 <img class="lg-item-img" src="{{url('public/assets/images/in1.jpg')}}" alt="">
                                             </div>
                                         ...
                                         <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                 <img class="lg-item-img" src="{{url('public/assets/images/in2.jpg')}}" alt="">
                                             </div>
                                             <div class="media-body">
                                                 <div class="pull-left">
                                         ...
                                         <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                 <img class="lg-item-img" src="{{url('public/assets/images/in3.jpg')}}" alt="">
                                             </div>
                                             <div class="media-body">
                                                 <div class="pull-left">
                     ...
                     <header class="logo1">
                         ...
                         <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                            <div class="menu">
							  ...
							  <li id="menu-academico" ><a href="{{url('/admin/userDetails')}}"><i class="fa fa-envelope nav_icon"></i><span>User's</span><div class="clearfix"></div></a></li>
