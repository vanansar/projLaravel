...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
        ...
        <link rel="stylesheet" href="{{url('public/assets/css/morris.css')}}" type="text/css" />
        <!-- Graph CSS -->
        ...
        <!-- lined-icons -->
        <link rel="stylesheet" href="{{url('public/assets/css/icon-font.min.css')}}" type='text/css' />
        <link rel="stylesheet" href="{{url('public/assets/data_tables/bootstrap.min.css')}}" />
               <script src="{{url('public/assets/data_tables/jquery.dataTables.min.js')}}"></script>
               <script src="{{url('public/assets/data_tables/dataTables.bootstrap.min.js')}}"></script>
               <link rel="stylesheet" href="{{url('public/assets/data_tables/dataTables.bootstrap.min.css')}}" />
        <style>
        .inbox-mail {
            display: none;
        }
    ...
    <div class="page-container">
        ...
        <div class="left-content">
            <div class="mother-grid-inner">
                            ...
                            <ul class="nofitications-dropdown">
                                <li class="dropdown head-dpdn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in11.jpg" alt=""></div>
                                        ...
                                        <li class="odd"><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in10.jpg" alt=""></div>
                                                <div class="notification_desc">
                                                    <p>Lorem ipsum dolor </p>
                                                    <p><span>1 hour ago</span></p>
                                                </div>
                                        ...
                                        <li><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in9.jpg" alt=""></div>
                                                <div class="notification_desc">
                                                    <p>Lorem ipsum dolor</p>
                                                    <p><span>1 hour ago</span></p>
                                                </div>
                                ...
                                <li class="dropdown head-dpdn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in8.jpg" alt=""></div>
                                                <div class="notification_desc">
                                                    <p>Lorem ipsum dolor</p>
                                                    <p><span>1 hour ago</span></p>
                                                </div>
                                        ...
                                        <li class="odd"><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in6.jpg" alt=""></div>
                                                <div class="notification_desc">
                                                    <p>Lorem ipsum dolor</p>
                                                    <p><span>1 hour ago</span></p>
                                                </div>
                                        ...
                                        <li><a href="#">
                                                <div class="user_img"><img src="public/assets/images/in7.jpg" alt=""></div>
                                                <div class="notification_desc">
                                                    <p>Lorem ipsum dolor</p>
                                                    <p><span>1 hour ago</span></p>
                                                </div>
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        <span class="prfil-img"><img src="public/assets/    images/in4.jpg" alt=""> </span>
                                        <div class="user-name">
                                            <p>Saravanan</p>
                ...
                <!--heder end here-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>User's</li>
                </ol>

                <div class="table-responsive"  id="mydiv">
            <table id="employee_data" style=" font-size: 15px;" class="table table-bordered">
                ...
                @foreach($view_user as $userDetails)
                ...
                <tr>
                    ...
                    <td>
                            <a href="{{ url('deleteUser/'.$userDetails->user_id) }}">
			...
			if(confirm("Are you sure want to delete it "))
			{
				$.ajax({
					...
					success: function(res)
					{
					  ...
					  del.closest('tr').hide("slow").fadeOut();
          // top.location.href="http://localhost/project/admin/inbox.php";
						}
					});
				}
				else {
                        ...
                        <nav class="nav-sidebar">
                            <ul class="nav tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab" aria-expanded="true"><i
                                            class="fa fa-inbox"></i>Users <span>9</span>
                                        <div class="clearfix"></div>
                                    </a></li>
                                <li class=""><a href="#tab2" data-toggle="tab" aria-expanded="false"><i
                                            class="fa fa-paper-plane-o"></i>Sent</a></li>
                                <li class=""><a href="#tab3" data-toggle="tab" aria-expanded="false"><i
                                    ...
                                    <div class="mail-toolbar clearfix">
                                        <div class="float-left">
                                            <div class="btn-group m-r-sm mail-hidden-options"
                                                ...
                                                <div class="btn-group">
                                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                                        aria-expanded="false"><i class="fa fa-tags"></i> <span
                                                            class="caret"></span></a>
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="#">Work</a></li>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    <li id="menu-academico"><a href="inbox.php"><i
                                class="fa fa-envelope nav_icon"></i><span>User's</span>
                            <div class="clearfix"></div>
                        </a></li>
